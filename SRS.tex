...
The website application will communicate with a GPS application for delivery locations. The website application will also communicate with a third party checkout gateway to securely process online payments.
...
%	\begin{flushleft}\bfseries{ID and Name: FR\thefunreq ~\hspace{.6cm} }\end{flushleft}
	...
	The system shall provide the right results on search. The systems shall accurately represent available products and their accurate quantities.
	
	\subsection{Availability}
	The system shall be accessible online at all times except in an instance where maintenance/upgrade is ongoing and a notification has been duly broadcast .
