...
The webpage must communicate with GPS applications for delivery locations in addition to other customer devices for pickup/delivery purposes. Potentially the webpage must also be able to interface with third party application which we will discuss further in Section 2 above. All/most employee activities will be performed with technology that communicates with the webpage for timekeeping, customer checkout, item inventory, delivery, and other various activities in the store; all activities/technologies will run potentially independent software that must interface with website.
